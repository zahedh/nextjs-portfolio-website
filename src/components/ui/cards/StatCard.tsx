...
export default function StatCard({ value, label }: StatCardProps) {
  return (
    <div className="border-brand-300 relative rounded-2xl border bg-neutral-100/80 px-5 py-3 shadow-lg backdrop-blur-sm xl:px-4 xl:py-2.5 2xl:px-6 2xl:py-4 dark:bg-neutral-900/80">
